...
export const pageNodeModule = defineNodeModule({ type: "pagina", labelKey: "nodes.page.label", nodeNameKey: "nodes.page.nodeName", color: PALETTE.pagina, renderer: "page", capabilities: { openOnPrimaryAction: true }, creation: { available: true, selectAfterCreation: true }, typePanel: { visible: true }, concept: { id: "pages", labelKey: "concepts.pages" }, defaultContent: "<p><br></p>" });
