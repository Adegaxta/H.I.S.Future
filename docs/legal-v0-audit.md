...
| Preferencias, rutas recientes y actividad local | [useProjectSession.ts](../src/project/useProjectSession.ts), [AppWorkspace.tsx](../src/components/AppWorkspace.tsx), [useNodeStore.ts](../src/hooks/useNodeStore.ts), [LocaleContext.tsx](../src/i18n/LocaleContext.tsx), [GraphView](../src/graph/view.tsx), [HisTip.tsx](../src/components/HisTip.tsx) |
